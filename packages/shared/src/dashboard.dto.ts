export interface SpendByMonthDto { month: string; total: number; }
export interface SpendByVendorDto { vendorId: string; shopName: string; total: number; pct: number; }
export interface SpendByCategoryDto { category: string; total: number; pct: number; }
